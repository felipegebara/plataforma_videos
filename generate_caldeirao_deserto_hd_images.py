...
CALDEIRAO_SCENES = [
    ...
    },
    {
        ...
        "duration": 8.5,
        "motion": "zoom_out",
        "query": "Sertanejo farmers Ceara Sertao historical",
        "fallback": "Sertao farm Brazil historical 1930s"
    },
    {
        "scene_id": 4,
        ...
        "duration": 9.0,
        "motion": "pan_right",
        "query": "Crato Ceara historical village 1930s",
        "fallback": "Old Sertao Brazil village historical"
    },
    {
        "scene_id": 5,
        ...
        "duration": 9.5,
        "motion": "zoom_in",
        "query": "Military Sertao Brazil historical 1930s",
...
def produce_caldeirao_video():
    topic_id = "misterio_caldeirao_do_deserto"
    t1 = "O CALDEIRÃO DE SANTA CRUZ"
    t2 = "O SEGUNDO CANUDOS DO SERTÃO"

    print(f"\n==========================================")
    print(f"[CALDEIRÃO DE SANTA CRUZ DO DESERTO] Gerando 6 Fotos Reais HD Históricas")
    print(f"==========================================")
    ...
    # Exportar Vídeo Master Final de Caldeirão
    ...
    print(f"  [OK] VÍDEO DO CALDEIRÃO CONCLUÍDO COM SUCESSO ({current_time:.1f}s): {master_path}")
    return master_path


def main():
    produce_caldeirao_video()
