...
SHORT_DEF = {
    "title": "Esculturas em Lego: Obras de Arte Surreais 🎨🧱",
    "hook": "AS ESCULTURAS MAIS SURREAIS EM LEGO! 🎨🧱",
    "filename": "16_Esculturas_em_Lego_Obras_de_Arte_Surreais",
    "narration": "Olha o nível destas esculturas feitas 100% de Lego! Na Masterpiece Gallery, artistas do mundo todo criam obras de arte surreais: desde um camarão e tubos de tinta até um aspirador de pó em tamanho real! Qual dessas esculturas em Lego você teria na sua casa?",
    "video_file": "WhatsApp Video 2026-08-31 at 22.03.23 (2).mp4",
    "start": 0.5,
    "dur": 15.0
}
...
def produce_esculturas_lego_short():
    print("==================================================================")
    print(" [ATUALIZANDO VÍDEO 16: ESCULTURAS EM LEGO 🎨🧱] ")
    print("==================================================================")
    ...
    voice_file = audio_dir / f"voice_esculturas_lego_{run_id}.mp3"
    ...
    temp_aud = str(output_shorts_dir / f"temp_audio_esculturas_{run_id}.m4a")
    ...
    # Também atualiza o arquivo antigo 16_O_Aspirador_de_Po_que_Devora_Bonecos_de_Lego.mp4 e short_legohouse_16_FINAL_MOVIE.mp4
    alt_p1 = output_shorts_dir / "16_O_Aspirador_de_Po_que_Devora_Bonecos_de_Lego.mp4"
    alt_p2 = output_shorts_dir / "short_legohouse_16_FINAL_MOVIE.mp4"
    import shutil
    ...
    print(f"\n🎉 [SHORT DE ESCULTURAS EM LEGO CONCLUÍDO COM SUCESSO!]")
    print(f"  - Duração: {target_dur:.1f}s")
    print(f"  - Arquivo: {master_path}")

if __name__ == "__main__":
    produce_esculturas_lego_short()
