...
# SHORT 3 EXCLUSIVO DE ANIMATRÔNICOS NA LEGOLAND (MANTENDO O VÍDEO EXACTO)
short_id = "short_legoland_3"
title = "Animatrônicos na Legoland 🤖"
hook_text = "ANIMATRÔNICOS NA LEGOLAND! 🤖"
narration = "Você sabia que a Legoland conta com vários robôs animatrônicos robóticos feitos de peças Lego? Eles se movimentam, cantam e interagem com os visitantes em atrações incríveis pelo parque!"

v_clips_def = [
    {"file": "WhatsApp Video 2026-08-12 at 18.49.45 (8).mp4", "start": 3.0, "dur": 14.5}
]
...
def main():
    print("==========================================")
    print("[PRODUZINDO SHORT 3: TEMA DE ANIMATRÔNICOS NA LEGOLAND MANTENDO O VÍDEO BRUTO!]")
    print("==========================================")
    ...
    print(f"\n  ✓ Short 3 [{short_id}]: {title} | Duração: {current_time:.1f}s -> {master_path}")
