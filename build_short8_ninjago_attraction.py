...
# SHORT 8 INTITULADO: ATRAÇÃO DO NINJAGO
short_id = "short_legoland_8"
title = "Atração do Ninjago 🥷"
hook_text = "ATRAÇÃO DO NINJAGO! 🥷"
narration = "Conheça todos os detalhes da incrível atração do Ninjago World na Legoland! Uma área imersiva repleta de guerreiros ninjas, desafios interativos e os dragões de Kai e Lloyd!"

v_clips_def = [
    {"file": "WhatsApp Video 2026-08-12 at 18.49.44 (5).mp4", "start": 2.0, "dur": 14.5}
]
...
def main():
    print("==========================================")
    print("[PRODUZINDO SHORT 8: ATRAÇÃO DO NINJAGO!]")
    print("==========================================")
    ...
    print(f"\n  ✓ Short 8 [{short_id}]: {title} | Duração: {current_time:.1f}s -> {master_path}")
