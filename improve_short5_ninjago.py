...
# MELHORIA COMPLETA DO SHORT 5 DO NINJAGO (DURAÇÃO IDEAL 14.5 SECS COM DUPLO VÍDEO E DINÂMICA ALTA)
short_id = "short_legoland_5"
title = "A Incrível Atração de LEGO Ninjago 🥷"
hook_text = "A INCRÍVEL ATRAÇÃO NINJAGO! 🥷"
narration = "Seja bem-vindo ao mundo secreto de Lego Ninjago! Aqui você entra no templo sagrado, treina como um verdadeiro ninja, domina a arte do Spinjitzu e encara uma aventura quatro de inesquecível com Kai, Lloyd e Zane!"
...
def main():
    print("==========================================")
    print("[MELHORANDO O SHORT 5 DO NINJAGO: DURAÇÃO DE 14.5s E CORTE DINÂMICO!]")
    print("==========================================")
    ...
    # 1. Primeiro Trecho de Vídeo: Entrada e Templo Ninja (5.5s)
    ...
    # 2. Segundo Trecho de Vídeo: Estátuas e Brinquedo dos Ninjas (Tempo restante)
    rem_dur = max(4.0, target_dur - current_time)
