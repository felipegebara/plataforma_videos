...
def fetch_ai_image(prompt: str, style_prefix: str, seed_id: int, out_path: Path) -> bool:
    ...
    seed_val = (int(time.time()) + seed_id * 7777) % 999999
...
def update_fulozinha_historica_scenes3_4():
    ...
    style_prefix = "Photorealistic 8k National Geographic documentary photograph, ARRI Alexa 65, historical 19th century Brazil, Zona da Mata Pernambuco, sugarcane plantation forest, atmospheric volumetric lighting, RAW"
    ...
    scenes_config = [
        ...
        # CENA 3 COM A FIGURA DA COMADRE FULOZINHA
        {
            "scene_id": 3,
            ...
            "prompt": "Photorealistic 8k mysterious spirit of Comadre Fulozinha, a young Brazilian indigenous-descendant forest guardian woman with extremely long dark hair floating around her, standing mysteriously among ancient rainforest trees, subtle golden aura, back view or mysterious silhouette"
        },
        # CENA 4 COM A FIGURA DA COMADRE FULOZINHA E AS OFERENDAS
        {
            "scene_id": 4,
            ...
            "prompt": "Photorealistic 8k close shot of Comadre Fulozinha, mysterious young forest woman with long black hair, delicately placing roll tobacco and a honey clay pot near an ancient banyan tree root in Pernambuco rainforest, cinematic lighting"
        },
        {
            "scene_id": 5,
    ...
    print("\n🎬 Atualizando Short Histórico com a figura da Comadre Fulozinha nas Cenas 3 e 4...")
    ...
    for sc in scenes_config:
        ...
        fetch_ai_image(prompt, style_prefix, 300 + sc_id, raw_p)
    ...
    print(f"🎉 [SHORT HISTÓRICO RE-MASTERIZADO CONCLUÍDO] Duração: {current_time:.1f}s -> {master_p}")

if __name__ == "__main__":
    update_fulozinha_historica_scenes3_4()
