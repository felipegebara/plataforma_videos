...
# Mapeamento 100% FIEL E VERÍDICO ao que REALMENTE APARECE no vídeo (SEM MENCIONAR ALIMENTAÇÃO)
EXACT_MATCHING_SPECS = [
    # SHORT 1: TARTARUGAS GIGANTES NOS TANQUES
    {
        ...
        "narration": "Você sabia que em Florianópolis existe um santuário incrível dedicado a salvar as tartarugas marinhas? No Projeto Tamar da Barra da Lagoa, você fica frente a frente com espécies gigantes nadando nos tanques! Siga o Rota Calculada!",
        "video_segments": [
            {"file": "WhatsApp Video 2026-08-08 at 14.03.06.mp4", "start": 10.0, "end": 24.5}
        ]
    },
    # SHORT 2: TARTARUGAS NADANDO NA ÁGUA CRISTALINA (SEM MENCIONAR ALIMENTAÇÃO!)
    {
        "topic_id": "short_tamar_floripa_2",
        "title": "Short 2: Tartarugas Marinhas em Água Cristalina",
        "hook_text": "NATAÇÃO DAS TARTARUGAS! 🌊🐢",
        "sub_text": "TANQUE PRINCIPAL DO TAMAR",
        "narration": "Olhe só a graciosidade dessa tartaruga marinha nadando no tanque do Projeto Tamar em Floripa! A água limpa permite ver cada detalhe do casco e das nadadeiras. É fascinante! Siga o Rota Calculada!",
        "video_segments": [
            {"file": "WhatsApp Video 2026-08-08 at 14.02.39.mp4", "start": 5.0, "end": 20.0}
        ]
    },
    # SHORT 3: CIRCUITO DE VISITAÇÃO E ESTRUTURA (SEM MENCIONAR ALIMENTAÇÃO!)
    {
        "topic_id": "short_tamar_floripa_3",
        "title": "Short 3: Vale a Pena Visitar o Tamar em Floripa",
        "hook_text": "VALE A PENA VISITAR O TAMAR? 📍🇧🇷",
        "sub_text": "CIRCUITO DE CAMINHADA E PLACAS",
        "narration": "Vale a pena visitar o Projeto Tamar na Barra da Lagoa em Floripa? Repare na estrutura do circuito de visitação, placas educativas e caminho arborizado. Um dos passeios mais bonitos da ilha! Salve esse vídeo e siga o Rota Calculada!",
        "video_segments": [
    ...
    # SHORT 4: PRESERVAÇÃO E REABILITAÇÃO
    {
    ...
    # SHORT 5: O MUSEU INTERNO E ENTRADA DO COMPLEXO (CORRIGIDO CONFORME PEDIDO DO USUÁRIO!)
    {
        "topic_id": "short_tamar_floripa_5",
        "title": "Short 5: O Museu e Entrada do Projeto Tamar",
        "hook_text": "MUSEU E ENTRADA DO TAMAR! 🏛️🐢",
        "sub_text": "ESPAÇO INTERATIVO E EDUCATIVO",
        "narration": "Veja a entrada do complexo e o museu educativo do Tamar! Com recepção decorada, painéis científicos e espaço interativo, é o local perfeito para aprender sobre a vida marinha em Floripa. Siga o Rota Calculada!",
        "video_segments": [
            {"file": "WhatsApp Video 2026-08-08 at 14.01.55.mp4", "start": 0.0, "end": 14.0}
        ]
    },
    # SHORT 6: EXPERIÊNCIA NA BARRA DA LAGOA (SEM MENCIONAR ALIMENTAÇÃO!)
    {
        "topic_id": "short_tamar_floripa_6",
        "title": "Short 6: Experiência na Barra da Lagoa em Floripa",
        "hook_text": "PASSEIO NA BARRA DA LAGOA! 🏖️🌊",
        "sub_text": "FLORIANÓPOLIS - SANTA CATARINA",
        "narration": "O Projeto Tamar está localizado estrategicamente na Barra da Lagoa em Florianópolis. Você combina o passeio ecológico com a beleza natural da ilha! Qual sua praia favorita em Floripa? Comente e siga o Rota Calculada!",
        "video_segments": [
            {"file": "WhatsApp Video 2026-08-08 at 14.01.13.mp4", "start": 0.0, "end": 14.0}
        ]
    }
]
...
def process_exact_matching_short(spec: dict):
    ...
    print(f"  ✓ [{title.upper()} TOTALMENTE CORRIGIDO] Duração: {target_dur:.1f}s -> {master_path}")

def fix_all_shorts_matching():
    print("==========================================")
    print("[CORRIGINDO OS SHORTS: REALINHANDO MUSEU NO SHORT 5 E REMOVENDO FALA DE ALIMENTAÇÃO]")
    print("==========================================")

    for spec in EXACT_MATCHING_SPECS:
        process_exact_matching_short(spec)

if __name__ == "__main__":
    fix_all_shorts_matching()
