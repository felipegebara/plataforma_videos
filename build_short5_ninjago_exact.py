...
# SHORT 5 EXCLUSIVO DO NINJAGO WORLD
short_id = "short_legoland_5"
title = "A Atração Ninja de LEGO Ninjago 🥷"
hook_text = "A ATRAÇÃO DO LEGO NINJAGO! 🥷"
narration = "Bem-vindo ao incrível LEGO Ninjago World! Veja a atração interativa dos ninjas, com o templo sagrado e os guerreiros Kai e Lloyd!"

v_clips_def = [
    {"file": "WhatsApp Video 2026-08-12 at 18.49.45 (2).mp4", "start": 0.5, "dur": 5.4}
]
...
def main():
    print("==========================================")
    print("[PRODUZINDO SHORT 5 FOCADO NO VÍDEO DO NINJAGO WORLD!]")
    print("==========================================")
