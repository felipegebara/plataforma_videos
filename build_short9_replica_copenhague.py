...
# SHORT 9 INTITULADO: RÉPLICA DE COPENHAGUE
short_id = "short_legoland_9"
title = "Réplica de Copenhague em Lego 🇩🇰"
hook_text = "RÉPLICA DE COPENHAGUE! 🇩🇰"
narration = "Esta é a impressionante réplica de Copenhague feita de Lego na Miniland! O porto de Nyhavn, os canais históricos e as casinhas coloridas reproduzidos com milhões de peças!"

v_clips_def = [
    {"file": "WhatsApp Video 2026-08-12 at 18.49.44 (6).mp4", "start": 3.0, "dur": 14.5}
]
...
def main():
    print("==========================================")
    print("[PRODUZINDO SHORT 9: RÉPLICA DE COPENHAGUE!]")
    print("==========================================")
    ...
    print(f"\n  ✓ Short 9 [{short_id}]: {title} | Duração: {current_time:.1f}s -> {master_path}")
