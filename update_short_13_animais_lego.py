...
SHORT_DEF = {
    "title": "Animais em Lego: Esculturas Selvagens Hiper-Realistas 🐅🧱",
    "hook": "OS ANIMAIS MAIS REALISTAS EM LEGO! 🐅🧱",
    "filename": "13_Animais_em_Lego_Esculturas_Hiper-Realistas",
    "narration": "Olha a perfeição destes animais selvagens esculpidos 100% em Lego! Artistas da Lego House recriaram este impressionante Tigre de Bengala com músculos anatômicos, garras e detalhes inacreditáveis sob galhos em flor! Qual animal você construiria com peças de Lego?",
    "video_file": "WhatsApp Video 2026-08-31 at 22.03.25 (2).mp4",
    "start": 0.5,
    "dur": 15.0
}
...
def produce_animais_lego_short():
    print("==================================================================")
    print(" [ATUALIZANDO VÍDEO 13: ANIMAIS EM LEGO 🐅🧱] ")
    print("==================================================================")
    ...
    voice_file = audio_dir / f"voice_animais_lego_{run_id}.mp3"
    ...
    temp_aud = str(output_shorts_dir / f"temp_audio_animais_{run_id}.m4a")
    ...
    # Também sincroniza com os nomes antigos para manter compatibilidade
    alt_p1 = output_shorts_dir / "13_O_Tigre_de_Bengala_Hiper-Realista_em_Escala_Real.mp4"
    alt_p2 = output_shorts_dir / "short_legohouse_13_FINAL_MOVIE.mp4"
    import shutil
    ...
    print(f"\n🎉 [SHORT DE ANIMAIS EM LEGO CONCLUÍDO COM SUCESSO!]")
    print(f"  - Duração: {target_dur:.1f}s")
    print(f"  - Arquivo: {master_path}")

if __name__ == "__main__":
    produce_animais_lego_short()
