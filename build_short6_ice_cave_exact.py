...
# SHORT 6 EXCLUSIVO DA CAVERNA DE GELO NA LEGOLAND
short_id = "short_legoland_6"
title = "A Misteriosa Caverna de Gelo 🧊"
hook_text = "A MISTERIOSA CAVERNA DE GELO! 🧊"
...
v_clips_def = [
    {"file": "WhatsApp Video 2026-08-12 at 18.49.46.mp4", "start": 1.0, "dur": 11.5}
]
...
def main():
    print("==========================================")
    print("[PRODUZINDO SHORT 6: TEMA DA CAVERNA DE GELO NA LEGOLAND!]")
    print("==========================================")
    ...
    print(f"\n  ✓ Short 6 [{short_id}]: {title} | Duração: {current_time:.1f}s -> {master_path}")
