...
FAROL_BARRA_HD_MAP = {
    1: BRAIN_DIR / "farol_scene1_1785412775928.jpg",
    2: BRAIN_DIR / "farol_scene2_1785412788229.jpg",
    3: BRAIN_DIR / "farol_scene3_1785412801029.jpg",
    4: BRAIN_DIR / "farol_scene4_1785412814656.jpg",
    5: BRAIN_DIR / "farol_scene5_1785412829184.jpg",
    6: BRAIN_DIR / "farol_scene6_1785412843172.jpg",
}

NEW_TOPICS = [
    {
        "id": "farol_da_barra",
        "title": "A LENDA DO FAROL DA BARRA",
        "topic_name": "A Lenda do Farol da Barra e os Naufrágios Secretos de Salvador",
        "script_scenes": [
            {
                "scene_id": 1,
                "narration": "O Farol da Barra e o Forte de Santo Antônio guardam séculos de mistérios marítimos na costa de Salvador.",
                "duration": 4.8,
                "motion": "zoom_in"
            },
            {
                "scene_id": 2,
                "narration": "Nas profundezas da Baía de Todos-os-Santos, repousam mais de cinquenta navios galeões espanhóis, holandeses e portugueses.",
                "duration": 5.2,
                "motion": "pan_right"
            },
            {
                "scene_id": 3,
                "narration": "Lendas contam que moedas de ouro e artefatos de corsários permanecem sepultados sob os corais e a areia das águas baianas.",
                "duration": 5.0,
                "motion": "zoom_out"
            },
            {
                "scene_id": 4,
                "narration": "Durante noites de nevoeiro, pescadores relatam luzes misteriosas sobre o mar, atribuídas às almas dos antigos marinheiros.",
                "duration": 5.0,
                "motion": "pan_left"
            },
            {
                "scene_id": 5,
                "narration": "Um patrimônio subaquático inestimável que transforma a costa de Salvador em um verdadeiro cemitério de caravelas.",
                "duration": 4.8,
                "motion": "zoom_in"
            },
            {
                "scene_id": 6,
                "narration": "Qual mistério submerso da Bahia mais te impressiona? Deixe seu comentário e compartilhe com os amigos!",
                "duration": 5.0,
                "motion": "zoom_out"
            }
        ]
...
def produce_video(topic_data: dict):
    print(f"\n==========================================")
    print(f"[PRODUCAO] Re-renderizando Farol da Barra com 100% de Imagens HD 9:16: {topic_data['title']}")
    print(f"==========================================")
    ...
    for sc in scenes:
        ...
        src_art = FAROL_BARRA_HD_MAP.get(scene_id)
        ...
        if src_art and src_art.exists():
            ...
            print(f"  ✓ Cena {scene_id}: Imagem HD 9:16 carregada perfeitamente")
        else:
        ...
        if scene_id == 1 and img_path.exists():
            ...
            parts = title_str.split(" DE ")
            line1 = parts[0]
            line2 = "DE " + parts[1] if len(parts) > 1 else title_str
        ...
        print(f"  [SCENE] Cena {scene_id} renderizada com imagem HD sem cortes ({voice_dur:.2f}s)")
    ...
    print(f"[OK] VIDEO DO FAROL DA BARRA RE-RENDERIZADO COM SUCESSO: {master_path}")
    return master_path


def main():
    print("[INIT] RE-RENDERIZACAO DE IMAGENS HD 9:16 PARA O FAROL DA BARRA")
    for t_data in NEW_TOPICS:
        produce_video(t_data)
    print("\n[SUCCESS] VIDEO DO FAROL DA BARRA RE-GERADO COM SUCESSO!")
