...
def fetch_ai_generated_image(prompt: str, seed_id: int, out_path: Path) -> bool:
    ...
    ai_url = f"https://image.pollinations.ai/prompt/{enc_p}?width=1080&height=1920&nologo=true&seed={14000 + seed_id}"
...
def produce_wan_hunyuan_caldeirao_video():
    ...
    print(f"\n==========================================")
    print(f"[ENGINE WAN 2.1/2.2 & HUNYUANVIDEO] Produzindo Vídeo (MoviePy Safe Lock)")
    print(f"==========================================")
    ...
    temp_audio_file = str(output_dir / "temp_audio_caldeirao.m4a")
