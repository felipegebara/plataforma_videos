...
# 1. DEFINIÇÃO DOS 6 SHORTS (13-16 SECONDS STRICT)
# SHORT 2 ATUALIZADO 100% PARA NINJAGO WORLD! 🥷
LEGOLAND_SHORTS_DEFINITIONS = [
    {
        ...
        "video_clips": [
            {"file": "WhatsApp Video 2026-08-12 at 18.49.45 (3).mp4", "start": 3.0, "dur": 2.5},
            {"file": "WhatsApp Video 2026-08-12 at 18.49.46 (5).mp4", "start": 3.0, "dur": 2.5},
            {"file": "WhatsApp Video 2026-08-12 at 18.49.46 (4).mp4", "start": 3.0, "dur": 2.5},
            {"file": "WhatsApp Video 2026-08-12 at 18.46.18.mp4", "start": 1.0, "dur": 2.5}
        ]
    },
    {
        ...
        "narration": "Bem-vindo ao incrível Ninjago World na Legoland! Uma área temática interativa onde você treina como um verdadeiro ninja de Lego, domina os quatro elementos e encara batalhas em Quatro D com Kai, Lloyd e Zane!",
        "video_clips": [{"file": "WhatsApp Video 2026-08-12 at 18.49.44 (5).mp4", "start": 3.0, "dur": 14.5}]
    },
    {
        "short_id": "short_legoland_3",
        "title": "Aviões e Navios Gigantes de Lego ✈️",
        "hook": "AVIÕES E NAVIOS DE LEGO! ✈️🚢",
        "narration": "Olha a perfeição desses aviões e navios de Lego em movimento! Todos os veículos da Miniland possuem motores elétricos reais que simulam o tráfego do aeroporto internacional de Billund!",
        "video_clips": [{"file": "WhatsApp Video 2026-08-12 at 18.49.46 (5).mp4", "start": 3.0, "dur": 14.8}]
    },
    {
        "short_id": "short_legoland_4",
        "title": "Montanhas-Russas da Legoland 🎢",
        "hook": "MONTANHA-RUSSA DENTRO DO CASTELO! 🎢",
        "narration": "Além das réplicas de cidades, a Legoland em Billund conta com montanhas-russas radicais como o Dragon Coaster, que passa por dentro de castelos medievais construídos em tamanho real!",
        "video_clips": [{"file": "WhatsApp Video 2026-08-12 at 18.49.46 (4).mp4", "start": 3.0, "dur": 14.5}]
    },
    {
        "short_id": "short_legoland_5",
        "title": "Canais e Barcos de Lego 🚤",
        "hook": "BARCOS DE LEGO QUE NAVEGAM DE VERDADE! 🚤",
        "narration": "Nos canais aquáticos de Miniland, barquetes de Lego navegam por eclusas reais com água de verdade, mostrando toda a genialidade e engenharia dinamarquesa por trás do parque!",
        "video_clips": [{"file": "WhatsApp Video 2026-08-12 at 18.49.46 (3).mp4", "start": 2.0, "dur": 14.2}]
    },
    {
        "short_id": "short_legoland_6",
        "title": "Vale a Pena Visitar a Legoland? 🇩🇰",
        "hook": "VALE A PENA CONHECER A LEGOLAND? 🇩🇰",
        "narration": "Visitar o parque Legoland em Billund na Dinamarca é uma experiência inesquecível tanto para crianças quanto para adultos apaixonados por criatividade e arquitetura! Um passeio imperdível.",
        "video_clips": [{"file": "WhatsApp Video 2026-08-12 at 18.49.46 (6).mp4", "start": 3.0, "dur": 14.8}]
    }
]

# 2. DOCUMENTÁRIO MASTER ESTENDIDO
...
def produce_all_legoland_videos():
    print("==========================================")
    print("[PRODUZINDO SUÍTE COMPLETA DA LEGOLAND: SHORT 2 NINJAGO WORLD! 🥷]")
    print("==========================================")
    ...
    # --- 1. PRODUZIR OS 6 SHORTS ---
    for idx, sdef in enumerate(LEGOLAND_SHORTS_DEFINITIONS, 1):
    ...
    print("\n[PRODUZINDO DOCUMENTÁRIO MASTER ESTENDIDO DA LEGOLAND (ZERO BURACOS DE ÁUDIO)]")
    long_video_clips = []
    long_audio_clips = []
    long_raw_keepalive = []
    long_time = 0.0
    ...
    print(f"\n🎉 [SUÍTE COMPLETA DA LEGOLAND CONCLUÍDA] 6 Shorts + Documentário Master ({long_time:.1f}s / {long_time/60.0:.2f} min) -> {long_master_path}")
